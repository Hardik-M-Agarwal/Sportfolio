    ...
    <aside className="w-64 min-h-screen bg-gray-900 flex flex-col">
      <div className="px-6 py-5 border-b border-white/10">
        <div className="font-black text-xl tracking-tight text-white" style={{ fontFamily: "'Syne', sans-serif" }}>
          Sport<span className="text-amber-400">folio</span>
        </div>
        <div className="text-xs text-white/40 mt-0.5">Sponsor Portal</div>
      </div>
        ...
        {navItems.map((item) => (
          <NavLink
            ...
            className={({ isActive }) =>
              ...
              ${isActive ? 'bg-amber-500 text-white' : 'text-white/60 hover:text-white hover:bg-white/8'}`
            }
          >
            {item.icon}
            {item.label}
